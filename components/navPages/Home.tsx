...
// import profile2 from "@/public/profile-pic2.jpeg"
import { MapPin } from 'lucide-react';
import Socials from '../Socials';
import { InteractiveHoverButton } from '../ui/interactive-hover-button';
export function Home() {
    const [isHovered, setIsHovered] = useState(false);
    const imageSwapEnabled = false; // set to true to re-enable image swap on hover
        ...
        <div id='home' className="w-full max-w-4xl flex flex-col items-center justify-center px-6 pt-20 pb-65 sm:min-h-screen relative">
            <div className="flex flex-col-reverse md:flex-row items-center md:items-start justify-between gap-10 w-full max-w-5xl">
                ...
                <div
                    ...
                    onMouseEnter={() => imageSwapEnabled && setIsHovered(true)}
                    onMouseLeave={() => imageSwapEnabled && setIsHovered(false)}
                >
                    {/* Base image */}
                    <Image
                        src={profile}
